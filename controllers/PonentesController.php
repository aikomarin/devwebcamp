...
class PonentesController {
    ...
    public static function crear(Router $router) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') { 
            ...
            if(!empty($_FILES['imagen']['tmp_name'])) {
                ...
                if(!is_dir($carpeta_imagenes)) mkdir($carpeta_imagenes, 0755, true); // Crear carpeta en caso de no existir
    ...
    public static function editar(Router $router) {
        ...
        $ponente->imagen_actual = $ponente->imagen; // Obtener imagen
        $redes = json_decode($ponente->redes); // Obtener redes sociales
